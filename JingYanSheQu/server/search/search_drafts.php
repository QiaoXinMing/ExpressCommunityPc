...
$id=$_POST["postInfo"];
$sql = "SELECT d.*,p.personal_id,p.personal_username FROM express_arctile_info d ,express_personal_info p WHERE d.personal_id ='$id' and d.personal_id = p.personal_id and resource_type = 'drafts'";
