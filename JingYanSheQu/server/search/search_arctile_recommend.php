...
$sql = "select a.arctile_id,a.arctile_title,a.arctile_content,a.resource_url,p.personal_username from express_arctile_info a , express_personal_info p where a.resource_url != '' order by arctile_looked asc LIMIT 8";
